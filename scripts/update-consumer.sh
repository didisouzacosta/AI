...
path="${path:-.}"; source="${BASH_SOURCE[0]}"
...
echo "Dependência AI atualizada. Revise e registre .ai/shared, .ai/managed-files.sha256, .codex, .agents, .swiftlint.yml, .swiftformat, scripts de lint/fix e o workflow Swift. Remova .swift-format se ele não for mais usado."
