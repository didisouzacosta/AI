...
safe_rel() { case "$1" in .codex/agents/*|.agents/skills/*) ;; *) is_lint_file "$1" || return 1;; esac; [[ "$1" != */ && "$1" != *//* && "$1" != */./* && "$1" != */../* && "$1" != *$'\n'* && "$1" != *$'\r'* ]]; }
